...
const About = () => {
  return (
    <section id="about" className="about">
      ...
      <h3 className="personnalInformationHeaderText">Personal Information</h3>
      <ul>
        {
